...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'type'                         => new sfValidatorChoice(array('required' => false, 'choices' => array('it-admin' => 'it-admin', 'user' => 'user'))),
  ...
  public function addResponsibleForCompanyListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('RefCompanyResponsible.group_id', $values)
    ;
  }
  ...
  public function addResponsibleForTicketsListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ->leftJoin($query->getRootAlias().'.RefTicketResponsible RefTicketResponsible')
      ->andWhereIn('RefTicketResponsible.ticket_id', $values)
    ;
  }
